  ...
  return (
    <div className="app">
        {/* <header style={{ height: headerHeight, display: 'flex', alignItems: 'center', padding: '0 20px', backgroundColor: '#282c34', color: 'white', fontFamily: 'Comfortaa, sans-serif' }}>
          <h1><Link to="/journalon/" style={{ textDecoration: 'none', color: 'inherit', marginRight: '20px' }}>Journalon</Link></h1>
          <Link to="/journalon/admin" style={{ textDecoration: 'none', color: 'inherit' }}>Admin</Link>
        </header> */}
